    ...
    stage(" Maven Clean Package"){
      ...
      stage('Pull Image Run Container'){
         sshagent(['Dok-Dep']) {      
          ...
          sh 'ssh centos@13.127.52.177 docker rm -f javaapps || true'
          sh "ssh centos@13.127.52.177 docker run -d -p 8080:8080 --name javaapps 942288870879.dkr.ecr.ap-south-1.amazonaws.com/javawebapp:${buildNumber}"
       }       
    }
}
